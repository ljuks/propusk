...
/* General labels */
define('LC_PAGE_TITLE','Оформление пропуска');

/* Heading labels */
define('LC_HEAD_TITLE','ZnetDK core application');
define('LC_HEAD_SUBTITLE','Ready for development...');
define('LC_HEAD_LNK_LOGOUT','Выход');
define('LC_HEAD_LNK_HELP','Помощь');
...
define('LC_FOOTER_CENTER','Copyright 2014-2018');
...
/* FORM titles */
define('LC_FORM_TITLE_LOGIN','Авторизация');
...
define('LC_FORM_TITLE_USER_MODIFY',"Редактировать");
define('LC_FORM_TITLE_USER_REMOVE',"Удалить");
define('LC_FORM_TITLE_PROFILE_NEW','Новый');
define('LC_FORM_TITLE_PROFILE_MODIFY',"Редактировать");
define('LC_FORM_TITLE_PROFILE_REMOVE',"Удалить");

/* Authorizations menu label */
define('LC_MENU_AUTHORIZATION','Авторизация');
define('LC_MENU_AUTHORIZ_USERS','Пользователи');
define('LC_MENU_AUTHORIZ_PROFILES','Профайлы');

/* Authorizations Datatable labels */
define('LC_TABLE_AUTHORIZ_USERS_CAPTION','Пользователи');
define('LC_TABLE_AUTHORIZ_PROFILES_CAPTION','Профайлы');
define('LC_TABLE_COL_LOGIN_ID','Логин');
define('LC_TABLE_COL_USER_NAME','Пользователь');
define('LC_TABLE_COL_USER_EMAIL','Email');
define('LC_TABLE_COL_USER_STATUS','Статус');
define('LC_TABLE_COL_MENU_ACCESS','Доступ к меню');
define('LC_TABLE_COL_USER_PROFILES','Профайл');
...
define('LC_FORM_LBL_ACCESS','Доступ');
...
define('LC_BTN_SELECTFILE','Выбрать...');
