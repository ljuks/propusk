...
$(function () {
    $.widget("znetdk.zdkdropdown", $.primeui.puidropdown, {
        ...
        /**
         * Overloads the parent method to unbind the events of the focusElement
         * property that was not unbent by the PrimeUI widget (bug fixing).
         */
        _unbindEvents: function() {
            this._super();
            this.focusElement.off();
        },
        /**
